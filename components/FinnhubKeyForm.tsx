...
export default function FinnhubKeyForm({ hasKey }: Props) {
  ...
  const handleSave = async () => {
    ...
    const res  = await fetch('/api/diario/key', {
      ...
      body:    JSON.stringify({ finnhub_key: key }),
    });
    ...
    <div className="bridge-config-form">
      <div className="form-group">
        ...
        <span className="field-hint">
          Grátis em <strong>finnhub.io</strong> → Dashboard → API Keys → Create Key.
